...
uint256 hashGenesisBlock("0x6053c8994fd4842b8f1dbe038662b7a1d16625d2bc36a40a5b3d24e4a7471e14");
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x035192955501d0863e23f057dddf7ddb2fd27a4877b664de6295bce6513ae496");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "Learn digital currency";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 20 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04f427b2a8cadb4c56013b431aa4c169917b3925072b0f2182a8ee77932cbd95915b852c26e01e4ff7addcd2c234bd0a4845642d907978f1873d7952522737da4b") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1621345655;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2085153906;

        if (fTestNet)
        {
            block.nTime    = 1621345622;
            block.nNonce   = 386103228;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x8180ab885b5b60f900af8b7f775f978f4a6c4a5772bdff56a3b8e15190a1a07f"));
        block.print();
